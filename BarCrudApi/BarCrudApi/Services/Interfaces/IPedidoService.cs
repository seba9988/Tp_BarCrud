...
namespace BarCrudApi.Services.Interfaces
{
    public interface IPedidoService
    {
        ...
        Task<Pedido?> GetPedidoPendiente(string id);
        //Busca historial de pedidos de un usuario
        Task<IList<PedidoHistorialViewModel>> GetHistorialUsuario(string userId);
        ...
        Task<bool> Compra(string userId);
        //Vacio el pedido pendiente del cliente y lo elimino
        Task<bool> CancelarPedido(string userId);
        //Verifica stock de los productos dentro del pedido
        bool VerificarStock(Pedido pedido);
    }
}
